...
=======
  const notices = [
    { title: "🚌 버스 배정 안내", time: "방금", content: "내일 출발 버스 번호를 확인하세요. 조별로 같은 버스에 탑승하며 8시 정각에 본당 앞에서 출발합니다.", urgent: true },
    { title: "🍽️ 1일차 식사 안내", time: "2시간 전", content: "5일 점심은 12:00~13:00입니다. 리조트 도착 후 식당으로 이동해주세요." },
    { title: "📋 수련회 준비물 체크리스트", time: "어제", content: "성경책, 필기도구, 여벌 옷(2박 3일분), 세면도구 등을 준비해주세요." },
  ];
          ...
          <div className="bg-white rounded-toss overflow-hidden shadow-sm border border-toss-border/40">
            {notices.slice(1).map((notice, idx) => (
              <NoticeItem 
                ...
                border={idx !== notices.slice(1).length - 1}
...
>>>>>>> b4faa304fd6adfa553c2a94df0bc3bd110c70ec1
}
